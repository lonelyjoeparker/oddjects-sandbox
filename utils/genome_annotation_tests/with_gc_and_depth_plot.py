...
def plot_dummy_content(record, window_size, ax):
    """Plot dummy content on a designated Matplotlib ax."""
    df = pd.read_csv('example_coverage_data.tdf',sep="\t",header=None,names=('chromosome','pos','depth'))
    """
...
plot_dummy_content(record, window_size=50, ax=ax3)
